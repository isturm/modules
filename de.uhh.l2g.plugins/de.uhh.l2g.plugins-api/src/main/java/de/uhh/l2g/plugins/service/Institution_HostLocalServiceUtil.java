...
public class Institution_HostLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<Institution_HostLocalService, Institution_HostLocalService> _serviceTracker =
		ServiceTrackerFactory.open(Institution_HostLocalService.class);
}