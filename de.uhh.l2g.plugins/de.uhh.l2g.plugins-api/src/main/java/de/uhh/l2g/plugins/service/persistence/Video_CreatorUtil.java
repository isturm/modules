...
/**
 * The persistence utility for the video_ creator service. This utility wraps {@link de.uhh.l2g.plugins.service.persistence.impl.Video_CreatorPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see de.uhh.l2g.plugins.service.persistence.impl.Video_CreatorPersistenceImpl
 * @generated
 */
@ProviderType
public class Video_CreatorUtil {
	...
	*/
	public static List<Video_Creator> findByVideo(long videoId, int start,
		int end) {
	...
	*/
	public static Video_Creator findByVideo_First(long videoId,
		OrderByComparator<Video_Creator> orderByComparator)
	...
	*/
	public static Video_Creator fetchByVideo_First(long videoId,
		OrderByComparator<Video_Creator> orderByComparator) {
	...
	* @throws NoSuchVideo_CreatorException if a matching video_ creator could not be found
	*/
	public static Video_Creator findByVideo_Last(long videoId,
		OrderByComparator<Video_Creator> orderByComparator)
		throws de.uhh.l2g.plugins.exception.NoSuchVideo_CreatorException {
	...
	*/
	public static Video_Creator fetchByVideo_Last(long videoId,
		OrderByComparator<Video_Creator> orderByComparator) {
	...
	*/
	public static Video_Creator[] findByVideo_PrevAndNext(long videoCreatorId,
	...
	* @return the range of matching video_ creators
	*/
	public static List<Video_Creator> findByCreator(long creatorId, int start,
		int end) {
	...
	* @throws NoSuchVideo_CreatorException if a matching video_ creator could not be found
	*/
	public static Video_Creator findByCreator_First(long creatorId,
		OrderByComparator<Video_Creator> orderByComparator)
		throws de.uhh.l2g.plugins.exception.NoSuchVideo_CreatorException {
	...
	* @return the first matching video_ creator, or <code>null</code> if a matching video_ creator could not be found
	*/
	public static Video_Creator fetchByCreator_First(long creatorId,
		OrderByComparator<Video_Creator> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchVideo_CreatorException if a matching video_ creator could not be found
	*/
	public static Video_Creator findByCreator_Last(long creatorId,
		OrderByComparator<Video_Creator> orderByComparator)
		throws de.uhh.l2g.plugins.exception.NoSuchVideo_CreatorException {
	...
	* @return the last matching video_ creator, or <code>null</code> if a matching video_ creator could not be found
	*/
	public static Video_Creator fetchByCreator_Last(long creatorId,
		OrderByComparator<Video_Creator> orderByComparator) {
	...
	* @return the matching video_ creators
	*/
	public static List<Video_Creator> findByVideoCreator(long videoId,
		long creatorId) {
	...
	* @throws NoSuchVideo_CreatorException if a matching video_ creator could not be found
	*/
	public static Video_Creator findByVideoCreator_First(long videoId,
	...
	* @return the first matching video_ creator, or <code>null</code> if a matching video_ creator could not be found
	*/
	public static Video_Creator fetchByVideoCreator_First(long videoId,
		long creatorId, OrderByComparator<Video_Creator> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchVideo_CreatorException if a matching video_ creator could not be found
	*/
	public static Video_Creator findByVideoCreator_Last(long videoId,
		long creatorId, OrderByComparator<Video_Creator> orderByComparator)
		throws de.uhh.l2g.plugins.exception.NoSuchVideo_CreatorException {
		return getPersistence()
	...
	* @return the last matching video_ creator, or <code>null</code> if a matching video_ creator could not be found
	*/
	public static Video_Creator fetchByVideoCreator_Last(long videoId,
		long creatorId, OrderByComparator<Video_Creator> orderByComparator) {
		return getPersistence()
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, Video_Creator> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<Video_CreatorPersistence, Video_CreatorPersistence> _serviceTracker =
		ServiceTrackerFactory.open(Video_CreatorPersistence.class);
}