...
public interface Producer_LectureseriesPersistence extends BasePersistence<Producer_Lectureseries> {
	...
	*/
	public java.util.List<Producer_Lectureseries> findByLectureseriesId(
		long lectureseriesId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Producer_Lectureseries> orderByComparator);
	...
	* @return the matching producer_ lectureserieses
	*/
	public java.util.List<Producer_Lectureseries> findByLectureseriesIdAndProducerId(
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, Producer_Lectureseries> fetchByPrimaryKeys(
