...
/**
 * The persistence utility for the lectureseries_ creator service. This utility wraps {@link de.uhh.l2g.plugins.service.persistence.impl.Lectureseries_CreatorPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see de.uhh.l2g.plugins.service.persistence.impl.Lectureseries_CreatorPersistenceImpl
 * @generated
 */
@ProviderType
public class Lectureseries_CreatorUtil {
	...
	*/
	public static Lectureseries_Creator findByLectureseries_First(
		long lectureseriesId,
		OrderByComparator<Lectureseries_Creator> orderByComparator)
		throws de.uhh.l2g.plugins.exception.NoSuchLectureseries_CreatorException {
		return getPersistence()
	...
	* @throws NoSuchLectureseries_CreatorException if a matching lectureseries_ creator could not be found
	*/
	public static Lectureseries_Creator findByCreator_First(long creatorId,
		OrderByComparator<Lectureseries_Creator> orderByComparator)
		throws de.uhh.l2g.plugins.exception.NoSuchLectureseries_CreatorException {
	...
	* @return the first matching lectureseries_ creator, or <code>null</code> if a matching lectureseries_ creator could not be found
	*/
	public static Lectureseries_Creator fetchByCreator_First(long creatorId,
		OrderByComparator<Lectureseries_Creator> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchLectureseries_CreatorException if a matching lectureseries_ creator could not be found
	*/
	public static Lectureseries_Creator findByCreator_Last(long creatorId,
		OrderByComparator<Lectureseries_Creator> orderByComparator)
		throws de.uhh.l2g.plugins.exception.NoSuchLectureseries_CreatorException {
	...
	* @return the last matching lectureseries_ creator, or <code>null</code> if a matching lectureseries_ creator could not be found
	*/
	public static Lectureseries_Creator fetchByCreator_Last(long creatorId,
		OrderByComparator<Lectureseries_Creator> orderByComparator) {
	...
	* @throws NoSuchLectureseries_CreatorException if a lectureseries_ creator with the primary key could not be found
	*/
	public static Lectureseries_Creator[] findByLectureseriesCreator_PrevAndNext(
	...
	*/
	public static void cacheResult(Lectureseries_Creator lectureseries_Creator) {
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, Lectureseries_Creator> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<Lectureseries_CreatorPersistence, Lectureseries_CreatorPersistence> _serviceTracker =
		ServiceTrackerFactory.open(Lectureseries_CreatorPersistence.class);
}