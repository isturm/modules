...
public interface Video_CreatorPersistence extends BasePersistence<Video_Creator> {
	...
	*/
	public java.util.List<Video_Creator> findByVideo(long videoId, int start,
		int end);
	...
	*/
	public java.util.List<Video_Creator> findByVideo(long videoId, int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<Video_Creator> orderByComparator);
	...
	* @return the matching video_ creators
	*/
	public java.util.List<Video_Creator> findByVideoCreator(long videoId,
		long creatorId);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, Video_Creator> fetchByPrimaryKeys(
