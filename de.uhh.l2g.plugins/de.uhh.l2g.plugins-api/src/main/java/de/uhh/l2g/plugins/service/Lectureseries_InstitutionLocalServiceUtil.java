...
public class Lectureseries_InstitutionLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<Lectureseries_InstitutionLocalService, Lectureseries_InstitutionLocalService> _serviceTracker =
		ServiceTrackerFactory.open(Lectureseries_InstitutionLocalService.class);
}