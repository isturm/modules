...
public interface Lectureseries_InstitutionPersistence extends BasePersistence<Lectureseries_Institution> {
	...
	*/
	public java.util.List<Lectureseries_Institution> findByLectureseriesId(
		long lectureseriesId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Lectureseries_Institution> orderByComparator);
	...
	* @return the matching lectureseries_ institutions
	*/
	public java.util.List<Lectureseries_Institution> findByLectureseriesIdAndInstitutionId(
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, Lectureseries_Institution> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<Lectureseries_Institution> findAll(int start, int end);
	...
	*/
	public java.util.List<Lectureseries_Institution> findAll(int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<Lectureseries_Institution> orderByComparator);
