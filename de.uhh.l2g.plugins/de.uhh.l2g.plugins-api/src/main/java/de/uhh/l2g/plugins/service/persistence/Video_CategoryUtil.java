...
/**
 * The persistence utility for the video_ category service. This utility wraps {@link de.uhh.l2g.plugins.service.persistence.impl.Video_CategoryPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see de.uhh.l2g.plugins.service.persistence.impl.Video_CategoryPersistenceImpl
 * @generated
 */
@ProviderType
public class Video_CategoryUtil {
	...
	*/
	public static List<Video_Category> findByVideo(long videoId, int start,
		int end) {
	...
	*/
	public static List<Video_Category> findByVideo(long videoId, int start,
		int end, OrderByComparator<Video_Category> orderByComparator) {
		return getPersistence()
	...
	*/
	public static Video_Category findByVideo_First(long videoId,
		OrderByComparator<Video_Category> orderByComparator)
	...
	*/
	public static Video_Category fetchByVideo_First(long videoId,
		OrderByComparator<Video_Category> orderByComparator) {
	...
	* @throws NoSuchVideo_CategoryException if a matching video_ category could not be found
	*/
	public static Video_Category findByVideo_Last(long videoId,
		OrderByComparator<Video_Category> orderByComparator)
		throws de.uhh.l2g.plugins.exception.NoSuchVideo_CategoryException {
	...
	*/
	public static Video_Category fetchByVideo_Last(long videoId,
		OrderByComparator<Video_Category> orderByComparator) {
	...
	* @throws NoSuchVideo_CategoryException if a matching video_ category could not be found
	*/
	public static Video_Category findByCategory_First(long categoryId,
		OrderByComparator<Video_Category> orderByComparator)
		throws de.uhh.l2g.plugins.exception.NoSuchVideo_CategoryException {
		return getPersistence()
	...
	* @return the first matching video_ category, or <code>null</code> if a matching video_ category could not be found
	*/
	public static Video_Category fetchByCategory_First(long categoryId,
		OrderByComparator<Video_Category> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchVideo_CategoryException if a matching video_ category could not be found
	*/
	public static Video_Category findByCategory_Last(long categoryId,
		OrderByComparator<Video_Category> orderByComparator)
		throws de.uhh.l2g.plugins.exception.NoSuchVideo_CategoryException {
		return getPersistence()
	...
	* @return the last matching video_ category, or <code>null</code> if a matching video_ category could not be found
	*/
	public static Video_Category fetchByCategory_Last(long categoryId,
		OrderByComparator<Video_Category> orderByComparator) {
		return getPersistence()
	...
	* @return the matching video_ categories
	*/
	public static List<Video_Category> findByVideoCategory(long videoId,
		long categoryId) {
	...
	* @throws NoSuchVideo_CategoryException if a matching video_ category could not be found
	*/
	public static Video_Category findByVideoCategory_First(long videoId,
	...
	* @return the first matching video_ category, or <code>null</code> if a matching video_ category could not be found
	*/
	public static Video_Category fetchByVideoCategory_First(long videoId,
		long categoryId, OrderByComparator<Video_Category> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchVideo_CategoryException if a matching video_ category could not be found
	*/
	public static Video_Category findByVideoCategory_Last(long videoId,
		long categoryId, OrderByComparator<Video_Category> orderByComparator)
		throws de.uhh.l2g.plugins.exception.NoSuchVideo_CategoryException {
		return getPersistence()
	...
	* @return the last matching video_ category, or <code>null</code> if a matching video_ category could not be found
	*/
	public static Video_Category fetchByVideoCategory_Last(long videoId,
		long categoryId, OrderByComparator<Video_Category> orderByComparator) {
		return getPersistence()
	...
	*/
	...
	/**
	* Returns the video_ category with the primary key or throws a {@link NoSuchVideo_CategoryException} if it could not be found.
	*
	* @param videoCategoryId the primary key of the video_ category
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, Video_Category> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<Video_CategoryPersistence, Video_CategoryPersistence> _serviceTracker =
		ServiceTrackerFactory.open(Video_CategoryPersistence.class);
}