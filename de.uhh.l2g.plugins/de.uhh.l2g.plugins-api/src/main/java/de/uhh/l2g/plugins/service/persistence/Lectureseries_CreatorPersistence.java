...
public interface Lectureseries_CreatorPersistence extends BasePersistence<Lectureseries_Creator> {
	...
	*/
	public java.util.List<Lectureseries_Creator> findByLectureseries(
		long lectureseriesId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Lectureseries_Creator> orderByComparator);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, Lectureseries_Creator> fetchByPrimaryKeys(
