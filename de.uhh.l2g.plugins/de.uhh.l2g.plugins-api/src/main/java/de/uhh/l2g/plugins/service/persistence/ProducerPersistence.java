...
public interface ProducerPersistence extends BasePersistence<Producer> {
	...
	* @return the range of matching producers
	*/
	public java.util.List<Producer> findByGroup(long groupId, int start, int end);
	...
	* @return the ordered range of matching producers
	*/
	public java.util.List<Producer> findByGroup(long groupId, int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<Producer> orderByComparator);
	...
	* @return the range of matching producers
	*/
	public java.util.List<Producer> findByCompany(long companyId, int start,
		int end);
	...
	* @return the matching producers
	*/
	public java.util.List<Producer> findByGroupAndCompany(long groupId,
		long companyId);
