 ...
 * @generated
 */
@ImplementationClassName("de.uhh.l2g.plugins.model.impl.Lectureseries_InstitutionImpl")
@ProviderType
public interface Lectureseries_Institution
	 ...
	 */
	public static final Accessor<Lectureseries_Institution, Long> LECTURESERIES_INSTITUTION_ID_ACCESSOR =
		new Accessor<Lectureseries_Institution, Long>() {
			@Override
			public Long get(Lectureseries_Institution lectureseries_Institution) {
				return lectureseries_Institution.getLectureseriesInstitutionId();
			}
