...
public interface MetadataPersistence extends BasePersistence<Metadata> {
	...
	*/
	public java.util.List<Metadata> findByGroup(long groupId, int start, int end);
	...
	*/
	public java.util.List<Metadata> findByGroup(long groupId, int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<Metadata> orderByComparator);
	...
	* @return the range of matching metadatas
	*/
	public java.util.List<Metadata> findByCompany(long companyId, int start,
		int end);
	...
	* @return the matching metadatas
	*/
	public java.util.List<Metadata> findByGroupAndCompany(long groupId,
		long companyId);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, Metadata> fetchByPrimaryKeys(
