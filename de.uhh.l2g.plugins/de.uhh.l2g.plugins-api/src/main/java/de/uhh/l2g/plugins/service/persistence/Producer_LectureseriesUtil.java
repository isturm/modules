...
/**
 * The persistence utility for the producer_ lectureseries service. This utility wraps {@link de.uhh.l2g.plugins.service.persistence.impl.Producer_LectureseriesPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see de.uhh.l2g.plugins.service.persistence.impl.Producer_LectureseriesPersistenceImpl
 * @generated
 */
@ProviderType
public class Producer_LectureseriesUtil {
	...
	*/
	public static Producer_Lectureseries findByLectureseriesId_First(
		long lectureseriesId,
		OrderByComparator<Producer_Lectureseries> orderByComparator)
		throws de.uhh.l2g.plugins.exception.NoSuchProducer_LectureseriesException {
		return getPersistence()
	...
	* @return the matching producer_ lectureserieses
	*/
	public static List<Producer_Lectureseries> findByProducerId(long producerId) {
	...
	* @return the matching producer_ lectureserieses
	*/
	public static List<Producer_Lectureseries> findByLectureseriesIdAndProducerId(
	...
	*/
	public static List<Producer_Lectureseries> findByLectureseriesIdAndProducerId(
		...
		return getPersistence()
				   .findByLectureseriesIdAndProducerId(lectureseriesId,
			producerId, start, end, orderByComparator, retrieveFromCache);
	}
	...
	* @throws NoSuchProducer_LectureseriesException if a matching producer_ lectureseries could not be found
	*/
	public static Producer_Lectureseries findByLectureseriesIdAndProducerId_First(
		long lectureseriesId, long producerId,
		OrderByComparator<Producer_Lectureseries> orderByComparator)
		throws de.uhh.l2g.plugins.exception.NoSuchProducer_LectureseriesException {
		return getPersistence()
	...
	* @return the first matching producer_ lectureseries, or <code>null</code> if a matching producer_ lectureseries could not be found
	*/
	public static Producer_Lectureseries fetchByLectureseriesIdAndProducerId_First(
		long lectureseriesId, long producerId,
		OrderByComparator<Producer_Lectureseries> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchProducer_LectureseriesException if a matching producer_ lectureseries could not be found
	*/
	public static Producer_Lectureseries findByLectureseriesIdAndProducerId_Last(
		long lectureseriesId, long producerId,
		OrderByComparator<Producer_Lectureseries> orderByComparator)
		throws de.uhh.l2g.plugins.exception.NoSuchProducer_LectureseriesException {
		return getPersistence()
	...
	* @return the last matching producer_ lectureseries, or <code>null</code> if a matching producer_ lectureseries could not be found
	*/
	public static Producer_Lectureseries fetchByLectureseriesIdAndProducerId_Last(
		long lectureseriesId, long producerId,
		OrderByComparator<Producer_Lectureseries> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchProducer_LectureseriesException if a producer_ lectureseries with the primary key could not be found
	*/
	public static Producer_Lectureseries[] findByLectureseriesIdAndProducerId_PrevAndNext(
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, Producer_Lectureseries> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<Producer_LectureseriesPersistence, Producer_LectureseriesPersistence> _serviceTracker =
		ServiceTrackerFactory.open(Producer_LectureseriesPersistence.class);
}