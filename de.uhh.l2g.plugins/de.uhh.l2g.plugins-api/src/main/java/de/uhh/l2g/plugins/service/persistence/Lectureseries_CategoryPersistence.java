...
public interface Lectureseries_CategoryPersistence extends BasePersistence<Lectureseries_Category> {
	...
	*/
	public java.util.List<Lectureseries_Category> findByLectureseries(
		long lectureseriesId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Lectureseries_Category> orderByComparator);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, Lectureseries_Category> fetchByPrimaryKeys(
