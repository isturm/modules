...
public interface Video_InstitutionPersistence extends BasePersistence<Video_Institution> {
	...
	*/
	public java.util.List<Video_Institution> findByVideo(long videoId,
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Video_Institution> orderByComparator);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, Video_Institution> fetchByPrimaryKeys(
