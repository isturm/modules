...
public interface SegmentPersistence extends BasePersistence<Segment> {
	...
	*/
	public java.util.List<Segment> findByVideo(long videoId, int start, int end);
	...
	*/
	public java.util.List<Segment> findByVideo(long videoId, int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<Segment> orderByComparator);
	...
	* @return the range of matching segments
	*/
	public java.util.List<Segment> findByGroup(long groupId, int start, int end);
	...
	* @return the ordered range of matching segments
	*/
	public java.util.List<Segment> findByGroup(long groupId, int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<Segment> orderByComparator);
	...
	* @return the range of matching segments
	*/
	public java.util.List<Segment> findByCompany(long companyId, int start,
		int end);
	...
	* @return the matching segments
	*/
	public java.util.List<Segment> findByGroupAndCompany(long groupId,
		long companyId);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, Segment> fetchByPrimaryKeys(
