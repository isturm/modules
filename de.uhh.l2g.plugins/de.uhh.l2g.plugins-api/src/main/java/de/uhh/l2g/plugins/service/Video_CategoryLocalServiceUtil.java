...
public class Video_CategoryLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<Video_CategoryLocalService, Video_CategoryLocalService> _serviceTracker =
		ServiceTrackerFactory.open(Video_CategoryLocalService.class);
}