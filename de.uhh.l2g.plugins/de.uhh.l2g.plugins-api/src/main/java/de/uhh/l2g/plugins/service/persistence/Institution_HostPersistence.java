...
public interface Institution_HostPersistence extends BasePersistence<Institution_Host> {
	...
	*/
	public java.util.List<Institution_Host> findByinstitutionId(
		long institutionId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Institution_Host> orderByComparator);
	...
	* @return the matching institution_ hosts
	*/
	public java.util.List<Institution_Host> findByG_H(long groupId, long hostId);
	...
	* @return the range of matching institution_ hosts
	*/
	public java.util.List<Institution_Host> findByG_H(long groupId,
	...
	* @return the matching institution_ hosts
	*/
	public java.util.List<Institution_Host> findByC_G_H(long companyId,
		long groupId, long hostId);
	...
	* @return the matching institution_ hosts
	*/
	public java.util.List<Institution_Host> findByC_G_I(long companyId,
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, Institution_Host> fetchByPrimaryKeys(
