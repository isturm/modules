...
/**
 * The persistence utility for the metadata service. This utility wraps {@link de.uhh.l2g.plugins.service.persistence.impl.MetadataPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see de.uhh.l2g.plugins.service.persistence.impl.MetadataPersistenceImpl
 * @generated
 */
@ProviderType
public class MetadataUtil {
	...
	*/
	public static Metadata findByGroup_First(long groupId,
		OrderByComparator<Metadata> orderByComparator)
	...
	*/
	public static Metadata fetchByGroup_First(long groupId,
		OrderByComparator<Metadata> orderByComparator) {
	...
	* @throws NoSuchMetadataException if a matching metadata could not be found
	*/
	public static Metadata findByGroup_Last(long groupId,
		OrderByComparator<Metadata> orderByComparator)
		throws de.uhh.l2g.plugins.exception.NoSuchMetadataException {
	...
	*/
	public static Metadata fetchByGroup_Last(long groupId,
		OrderByComparator<Metadata> orderByComparator) {
	...
	*/
	public static Metadata[] findByGroup_PrevAndNext(long metadataId,
		long groupId, OrderByComparator<Metadata> orderByComparator)
		throws de.uhh.l2g.plugins.exception.NoSuchMetadataException {
		return getPersistence()
				   .findByGroup_PrevAndNext(metadataId, groupId,
			orderByComparator);
	}
	...
	* @return the range of matching metadatas
	*/
	public static List<Metadata> findByCompany(long companyId, int start,
		int end) {
	...
	*/
	public static List<Metadata> findByCompany(long companyId, int start,
		int end, OrderByComparator<Metadata> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchMetadataException if a matching metadata could not be found
	*/
	public static Metadata findByCompany_First(long companyId,
		OrderByComparator<Metadata> orderByComparator)
		throws de.uhh.l2g.plugins.exception.NoSuchMetadataException {
	...
	* @return the first matching metadata, or <code>null</code> if a matching metadata could not be found
	*/
	public static Metadata fetchByCompany_First(long companyId,
		OrderByComparator<Metadata> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchMetadataException if a matching metadata could not be found
	*/
	public static Metadata findByCompany_Last(long companyId,
		OrderByComparator<Metadata> orderByComparator)
		throws de.uhh.l2g.plugins.exception.NoSuchMetadataException {
	...
	* @return the last matching metadata, or <code>null</code> if a matching metadata could not be found
	*/
	public static Metadata fetchByCompany_Last(long companyId,
		OrderByComparator<Metadata> orderByComparator) {
	...
	* @throws NoSuchMetadataException if a metadata with the primary key could not be found
	*/
	public static Metadata[] findByCompany_PrevAndNext(long metadataId,
		long companyId, OrderByComparator<Metadata> orderByComparator)
		throws de.uhh.l2g.plugins.exception.NoSuchMetadataException {
		return getPersistence()
				   .findByCompany_PrevAndNext(metadataId, companyId,
			orderByComparator);
	}
	...
	* @return the matching metadatas
	*/
	public static List<Metadata> findByGroupAndCompany(long groupId,
		long companyId) {
	...
	* @throws NoSuchMetadataException if a matching metadata could not be found
	*/
	public static Metadata findByGroupAndCompany_First(long groupId,
		long companyId, OrderByComparator<Metadata> orderByComparator)
		throws de.uhh.l2g.plugins.exception.NoSuchMetadataException {
		return getPersistence()
	...
	* @return the first matching metadata, or <code>null</code> if a matching metadata could not be found
	*/
	public static Metadata fetchByGroupAndCompany_First(long groupId,
		long companyId, OrderByComparator<Metadata> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchMetadataException if a matching metadata could not be found
	*/
	public static Metadata findByGroupAndCompany_Last(long groupId,
		long companyId, OrderByComparator<Metadata> orderByComparator)
		throws de.uhh.l2g.plugins.exception.NoSuchMetadataException {
		return getPersistence()
	...
	* @return the last matching metadata, or <code>null</code> if a matching metadata could not be found
	*/
	public static Metadata fetchByGroupAndCompany_Last(long groupId,
		long companyId, OrderByComparator<Metadata> orderByComparator) {
		return getPersistence()
	...
	*/
	public static Metadata[] findByGroupAndCompany_PrevAndNext(
		...
		throws de.uhh.l2g.plugins.exception.NoSuchMetadataException {
		return getPersistence()
				   .findByGroupAndCompany_PrevAndNext(metadataId, groupId,
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, Metadata> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<MetadataPersistence, MetadataPersistence> _serviceTracker =
		ServiceTrackerFactory.open(MetadataPersistence.class);
}