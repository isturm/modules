...
/**
 * The persistence utility for the sys service. This utility wraps {@link de.uhh.l2g.plugins.service.persistence.impl.SysPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @author Iavor Sturm
 * @see SysPersistence
 * @see de.uhh.l2g.plugins.service.persistence.impl.SysPersistenceImpl
 * @generated
 */
@ProviderType
public class SysUtil {
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, Sys> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<SysPersistence, SysPersistence> _serviceTracker =
		ServiceTrackerFactory.open(SysPersistence.class);
}