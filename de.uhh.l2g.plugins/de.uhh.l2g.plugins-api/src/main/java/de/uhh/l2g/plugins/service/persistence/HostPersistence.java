...
public interface HostPersistence extends BasePersistence<Host> {
	...
	* @return the matching hosts
	*/
	public java.util.List<Host> findByCompanyIdAndGroupId(long companyId,
		long groupId);
	...
	* @return the range of matching hosts
	*/
	public java.util.List<Host> findByCompanyId(long companyId, int start,
		int end);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, Host> fetchByPrimaryKeys(
