...
public interface Video_CategoryPersistence extends BasePersistence<Video_Category> {
	...
	*/
	public java.util.List<Video_Category> findByVideo(long videoId, int start,
		int end);
	...
	*/
	public java.util.List<Video_Category> findByVideo(long videoId, int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<Video_Category> orderByComparator);
	...
	* @return the matching video_ categories
	*/
	public java.util.List<Video_Category> findByVideoCategory(long videoId,
		long categoryId);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, Video_Category> fetchByPrimaryKeys(
