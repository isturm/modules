...
public class VideohitlistLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<VideohitlistLocalService, VideohitlistLocalService> _serviceTracker =
		ServiceTrackerFactory.open(VideohitlistLocalService.class);
}