...
public class Lectureseries_CreatorLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<Lectureseries_CreatorLocalService, Lectureseries_CreatorLocalService> _serviceTracker =
		ServiceTrackerFactory.open(Lectureseries_CreatorLocalService.class);
}