...
public interface StatisticPersistence extends BasePersistence<Statistic> {
	...
	*/
	public java.util.List<Statistic> findByGroup(long groupId, int start,
		int end);
	...
	*/
	public java.util.List<Statistic> findByGroup(long groupId, int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<Statistic> orderByComparator);
	...
	* @return the range of matching statistics
	*/
	public java.util.List<Statistic> findByCompany(long companyId, int start,
		int end);
	...
	* @return the matching statistics
	*/
	public java.util.List<Statistic> findByGroupAndCompany(long groupId,
		long companyId);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, Statistic> fetchByPrimaryKeys(
