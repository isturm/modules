...
public class MetadataPersistenceImpl extends BasePersistenceImpl<Metadata>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUP = new FinderPath(MetadataModelImpl.ENTITY_CACHE_ENABLED,
			MetadataModelImpl.FINDER_CACHE_ENABLED, MetadataImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUP = new FinderPath(MetadataModelImpl.ENTITY_CACHE_ENABLED,
			MetadataModelImpl.FINDER_CACHE_ENABLED, MetadataImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByGroup",
			new String[] { Long.class.getName() },
			MetadataModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUP = new FinderPath(MetadataModelImpl.ENTITY_CACHE_ENABLED,
			MetadataModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public Metadata findByGroup_First(long groupId,
		OrderByComparator<Metadata> orderByComparator)
	 ...
	 */
	@Override
	public Metadata fetchByGroup_First(long groupId,
		OrderByComparator<Metadata> orderByComparator) {
	 ...
	 */
	@Override
	public Metadata findByGroup_Last(long groupId,
		OrderByComparator<Metadata> orderByComparator)
		throws NoSuchMetadataException {
	 ...
	 */
	@Override
	public Metadata fetchByGroup_Last(long groupId,
		OrderByComparator<Metadata> orderByComparator) {
		...
		List<Metadata> list = findByGroup(groupId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Metadata[] findByGroup_PrevAndNext(long metadataId, long groupId,
		OrderByComparator<Metadata> orderByComparator)
		throws NoSuchMetadataException {
		...
		try {
			...
			array[0] = getByGroup_PrevAndNext(session, metadata, groupId,
					orderByComparator, true);

			array[1] = metadata;

			array[2] = getByGroup_PrevAndNext(session, metadata, groupId,
	...
	protected Metadata getByGroup_PrevAndNext(Session session,
		Metadata metadata, long groupId,
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByConditionValues(metadata);
	...
	public void removeByGroup(long groupId) {
		for (Metadata metadata : findByGroup(groupId, QueryUtil.ALL_POS,
	...
	private static final String _FINDER_COLUMN_GROUP_GROUPID_2 = "metadata.groupId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_COMPANY = new FinderPath(MetadataModelImpl.ENTITY_CACHE_ENABLED,
			MetadataModelImpl.FINDER_CACHE_ENABLED, MetadataImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANY =
		new FinderPath(MetadataModelImpl.ENTITY_CACHE_ENABLED,
			MetadataModelImpl.FINDER_CACHE_ENABLED, MetadataImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByCompany",
			new String[] { Long.class.getName() },
			MetadataModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANY = new FinderPath(MetadataModelImpl.ENTITY_CACHE_ENABLED,
			MetadataModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public Metadata findByCompany_First(long companyId,
		OrderByComparator<Metadata> orderByComparator)
		throws NoSuchMetadataException {
	 ...
	 */
	@Override
	public Metadata fetchByCompany_First(long companyId,
		OrderByComparator<Metadata> orderByComparator) {
	 ...
	 */
	@Override
	public Metadata findByCompany_Last(long companyId,
		OrderByComparator<Metadata> orderByComparator)
		throws NoSuchMetadataException {
	 ...
	 */
	@Override
	public Metadata fetchByCompany_Last(long companyId,
		OrderByComparator<Metadata> orderByComparator) {
		...
		List<Metadata> list = findByCompany(companyId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Metadata[] findByCompany_PrevAndNext(long metadataId,
		...
		try {
			...
			array[0] = getByCompany_PrevAndNext(session, metadata, companyId,
					orderByComparator, true);

			array[1] = metadata;

			array[2] = getByCompany_PrevAndNext(session, metadata, companyId,
					orderByComparator, false);
	...
	protected Metadata getByCompany_PrevAndNext(Session session,
		Metadata metadata, long companyId,
		OrderByComparator<Metadata> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByCompany(long companyId) {
		for (Metadata metadata : findByCompany(companyId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(metadata);
		}
	}
	...
	private static final String _FINDER_COLUMN_COMPANY_COMPANYID_2 = "metadata.companyId = ?";
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPANDCOMPANY =
		new FinderPath(MetadataModelImpl.ENTITY_CACHE_ENABLED,
			...
			MetadataModelImpl.GROUPID_COLUMN_BITMASK |
			MetadataModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUPANDCOMPANY = new FinderPath(MetadataModelImpl.ENTITY_CACHE_ENABLED,
			MetadataModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public Metadata findByGroupAndCompany_First(long groupId, long companyId,
		OrderByComparator<Metadata> orderByComparator)
		throws NoSuchMetadataException {
		Metadata metadata = fetchByGroupAndCompany_First(groupId, companyId,
				orderByComparator);
	 ...
	 */
	@Override
	public Metadata fetchByGroupAndCompany_First(long groupId, long companyId,
		OrderByComparator<Metadata> orderByComparator) {
		List<Metadata> list = findByGroupAndCompany(groupId, companyId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public Metadata findByGroupAndCompany_Last(long groupId, long companyId,
		OrderByComparator<Metadata> orderByComparator)
		throws NoSuchMetadataException {
		Metadata metadata = fetchByGroupAndCompany_Last(groupId, companyId,
				orderByComparator);
	 ...
	 */
	@Override
	public Metadata fetchByGroupAndCompany_Last(long groupId, long companyId,
		OrderByComparator<Metadata> orderByComparator) {
		...
		List<Metadata> list = findByGroupAndCompany(groupId, companyId,
	 ...
	 */
	@Override
	public Metadata[] findByGroupAndCompany_PrevAndNext(long metadataId,
		...
		try {
			...
			array[0] = getByGroupAndCompany_PrevAndNext(session, metadata,
					groupId, companyId, orderByComparator, true);

			array[1] = metadata;

			array[2] = getByGroupAndCompany_PrevAndNext(session, metadata,
	...
	protected Metadata getByGroupAndCompany_PrevAndNext(Session session,
		Metadata metadata, long groupId, long companyId,
		OrderByComparator<Metadata> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByGroupAndCompany(long groupId, long companyId) {
		for (Metadata metadata : findByGroupAndCompany(groupId, companyId,
	...
	private static final String _FINDER_COLUMN_GROUPANDCOMPANY_GROUPID_2 = "metadata.groupId = ? AND ";
	private static final String _FINDER_COLUMN_GROUPANDCOMPANY_COMPANYID_2 = "metadata.companyId = ?";
	...
	private static final String _SQL_SELECT_METADATA_WHERE = "SELECT metadata FROM Metadata metadata WHERE ";
	private static final String _SQL_COUNT_METADATA = "SELECT COUNT(metadata) FROM Metadata metadata";
	private static final String _SQL_COUNT_METADATA_WHERE = "SELECT COUNT(metadata) FROM Metadata metadata WHERE ";
	...
	private static final String _NO_SUCH_ENTITY_WITH_KEY = "No Metadata exists with the key {";
