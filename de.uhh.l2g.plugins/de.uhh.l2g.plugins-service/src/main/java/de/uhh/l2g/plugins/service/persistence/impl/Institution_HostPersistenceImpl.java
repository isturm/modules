 ...
 * @see de.uhh.l2g.plugins.service.persistence.Institution_HostUtil
 * @generated
 */
@ProviderType
public class Institution_HostPersistenceImpl extends BasePersistenceImpl<Institution_Host>
	...
	public List<Institution_Host> findByinstitutionId(long institutionId,
		...
		if (retrieveFromCache) {
			list = (List<Institution_Host>)finderCache.getResult(finderPath,
					finderArgs, this);
	...
	protected Institution_Host getByinstitutionId_PrevAndNext(Session session,
		...
		OrderByComparator<Institution_Host> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Returns the institution_ host where groupId = &#63; and institutionId = &#63; or throws a {@link NoSuchInstitution_HostException} if it could not be found.
	 *
	 * @param groupId the group ID
	 * @param institutionId the institution ID
	...
	public Institution_Host fetchByG_I(long groupId, long institutionId,
		...
		if (retrieveFromCache) {
			result = finderCache.getResult(FINDER_PATH_FETCH_BY_G_I,
					finderArgs, this);
		}
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					finderCache.putResult(FINDER_PATH_FETCH_BY_G_I, finderArgs,
						list);
				}
				else {
					if (list.size() > 1) {
					...
					if ((institution_Host.getGroupId() != groupId) ||
						...
						finderCache.putResult(FINDER_PATH_FETCH_BY_G_I,
							finderArgs, institution_Host);
					}
				}
			}
			catch (Exception e) {
				finderCache.removeResult(FINDER_PATH_FETCH_BY_G_I, finderArgs);
	...
	public List<Institution_Host> findByGroupId(long groupId, int start,
		int end, OrderByComparator<Institution_Host> orderByComparator) {
	...
	public List<Institution_Host> findByC_G_H(long companyId, long groupId,
		long hostId, int start, int end,
		OrderByComparator<Institution_Host> orderByComparator) {
		return findByC_G_H(companyId, groupId, hostId, start, end,
			orderByComparator, true);
	}
	...
	public List<Institution_Host> findByC_G_I(long companyId, long groupId,
		long institutionId, int start, int end,
		OrderByComparator<Institution_Host> orderByComparator) {
		return findByC_G_I(companyId, groupId, institutionId, start, end,
			orderByComparator, true);
	}
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_COMPANYANDHOST =
		new FinderPath(Institution_HostModelImpl.ENTITY_CACHE_ENABLED,
			Institution_HostModelImpl.FINDER_CACHE_ENABLED,
			Institution_HostImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYANDHOST =
		new FinderPath(Institution_HostModelImpl.ENTITY_CACHE_ENABLED,
			Institution_HostModelImpl.FINDER_CACHE_ENABLED,
			Institution_HostImpl.class,
			...
			Institution_HostModelImpl.COMPANYID_COLUMN_BITMASK |
			Institution_HostModelImpl.HOSTID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYANDHOST = new FinderPath(Institution_HostModelImpl.ENTITY_CACHE_ENABLED,
			Institution_HostModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Institution_Host> findBycompanyAndHost(long companyId,
		long hostId) {
		return findBycompanyAndHost(companyId, hostId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<Institution_Host> findBycompanyAndHost(long companyId,
		long hostId, int start, int end,
		OrderByComparator<Institution_Host> orderByComparator) {
		return findBycompanyAndHost(companyId, hostId, start, end,
			orderByComparator, true);
	}
	...
	public List<Institution_Host> findBycompanyAndHost(long companyId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYANDHOST;
			finderArgs = new Object[] { companyId, hostId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_COMPANYANDHOST;
			finderArgs = new Object[] {
					companyId, hostId,
	 ...
	 */
	@Override
	public Institution_Host findBycompanyAndHost_First(long companyId,
		long hostId, OrderByComparator<Institution_Host> orderByComparator)
		throws NoSuchInstitution_HostException {
		Institution_Host institution_Host = fetchBycompanyAndHost_First(companyId,
	 ...
	 */
	@Override
	public Institution_Host fetchBycompanyAndHost_First(long companyId,
		long hostId, OrderByComparator<Institution_Host> orderByComparator) {
		List<Institution_Host> list = findBycompanyAndHost(companyId, hostId,
				0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Institution_Host findBycompanyAndHost_Last(long companyId,
		long hostId, OrderByComparator<Institution_Host> orderByComparator)
		throws NoSuchInstitution_HostException {
		Institution_Host institution_Host = fetchBycompanyAndHost_Last(companyId,
				hostId, orderByComparator);
	 ...
	 */
	@Override
	public Institution_Host fetchBycompanyAndHost_Last(long companyId,
		long hostId, OrderByComparator<Institution_Host> orderByComparator) {
	...
	public Institution_Host[] findBycompanyAndHost_PrevAndNext(
		...
		try {
			...
			array[0] = getBycompanyAndHost_PrevAndNext(session,
					institution_Host, companyId, hostId, orderByComparator, true);

			array[1] = institution_Host;

			array[2] = getBycompanyAndHost_PrevAndNext(session,
					institution_Host, companyId, hostId, orderByComparator,
					false);
	...
	public void removeBycompanyAndHost(long companyId, long hostId) {
		for (Institution_Host institution_Host : findBycompanyAndHost(
	...
	public int countBycompanyAndHost(long companyId, long hostId) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_COMPANYANDHOST;
	...
	private static final String _FINDER_COLUMN_COMPANYANDHOST_COMPANYID_2 = "institution_Host.companyId = ? AND ";
	private static final String _FINDER_COLUMN_COMPANYANDHOST_HOSTID_2 = "institution_Host.hostId = ?";
	...
	public void cacheResult(Institution_Host institution_Host) {
		entityCache.putResult(Institution_HostModelImpl.ENTITY_CACHE_ENABLED,
	...
	public void clearCache(Institution_Host institution_Host) {
		entityCache.removeResult(Institution_HostModelImpl.ENTITY_CACHE_ENABLED,
			Institution_HostImpl.class, institution_Host.getPrimaryKey());

		finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITH_PAGINATION);
		finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);

		clearUniqueFindersCache((Institution_HostModelImpl)institution_Host,
			true);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(FINDER_PATH_COUNT_BY_G_I, args, Long.valueOf(1),
			false);
		finderCache.putResult(FINDER_PATH_FETCH_BY_G_I, args,
			institution_HostModelImpl, false);
	}
	...
	protected void clearUniqueFindersCache(
		...
		if (clearCurrent) {
			...
			finderCache.removeResult(FINDER_PATH_COUNT_BY_G_I, args);
			finderCache.removeResult(FINDER_PATH_FETCH_BY_G_I, args);
		}
	...
	public Institution_Host create(long institutionHostId) {
		...
		institution_Host.setCompanyId(companyProvider.getCompanyId());
	...
	public Institution_Host updateImpl(Institution_Host institution_Host) {
		...
		try {
			...
			if (institution_Host.isNew()) {
				...
				institution_Host = (Institution_Host)session.merge(institution_Host);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (!Institution_HostModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			finderCache.removeResult(FINDER_PATH_COUNT_BY_HOSTID, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_HOSTID,
				args);
			...
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_H,
				args);
			...
			finderCache.removeResult(FINDER_PATH_COUNT_BY_C_G_H, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_G_H,
				args);
			...
			finderCache.removeResult(FINDER_PATH_COUNT_BY_C_G_I, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_G_I,
				args);
			...
			finderCache.removeResult(FINDER_PATH_COUNT_BY_COMPANYANDHOST, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYANDHOST,
				args);
			...
			if ((institution_HostModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYANDHOST.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						institution_HostModelImpl.getOriginalCompanyId(),
						institution_HostModelImpl.getOriginalHostId()
					};

				finderCache.removeResult(FINDER_PATH_COUNT_BY_COMPANYANDHOST,
					args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYANDHOST,
					args);
	...
	/**
	 * Returns the institution_ host with the primary key or throws a {@link com.liferay.portal.kernel.exception.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the institution_ host
	...
	/**
	 * Returns the institution_ host with the primary key or throws a {@link NoSuchInstitution_HostException} if it could not be found.
	 *
	 * @param institutionHostId the primary key of the institution_ host
	 * @return the institution_ host
	 * @throws NoSuchInstitution_HostException if a institution_ host with the primary key could not be found
	...
	public Institution_Host fetchByPrimaryKey(Serializable primaryKey) {
		Serializable serializable = entityCache.getResult(Institution_HostModelImpl.ENTITY_CACHE_ENABLED,
	...
	public Map<Serializable, Institution_Host> fetchByPrimaryKeys(
		...
		Map<Serializable, Institution_Host> map = new HashMap<Serializable, Institution_Host>();
		...
		try {
			...
			for (Institution_Host institution_Host : (List<Institution_Host>)q.list()) {
	...
	private static final String _SQL_SELECT_INSTITUTION_HOST_WHERE_PKS_IN = "SELECT institution_Host FROM Institution_Host institution_Host WHERE institutionHostId IN (";
	...
	private static final Log _log = LogFactoryUtil.getLog(Institution_HostPersistenceImpl.class);
}