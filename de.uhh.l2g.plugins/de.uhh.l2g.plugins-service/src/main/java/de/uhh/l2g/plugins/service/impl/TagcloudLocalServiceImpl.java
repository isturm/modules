 ...
 *
 * @author Iavor Sturm
 * @see TagcloudLocalServiceBaseImpl
...
public class TagcloudLocalServiceImpl extends TagcloudLocalServiceBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Always use {@link de.uhh.l2g.plugins.service.TagcloudLocalServiceUtil} to access the tagcloud local service.
	 */
}