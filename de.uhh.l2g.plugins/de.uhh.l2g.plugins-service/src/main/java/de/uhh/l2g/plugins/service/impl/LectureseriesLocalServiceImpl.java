 ...
 *
 * @author Iavor Sturm
 * @see LectureseriesLocalServiceBaseImpl
...
public class LectureseriesLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Always use {@link de.uhh.l2g.plugins.service.LectureseriesLocalServiceUtil} to access the lectureseries local service.
	 */
}