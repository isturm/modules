...
public class LastvideolistPersistenceImpl extends BasePersistenceImpl<Lastvideolist>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUP = new FinderPath(LastvideolistModelImpl.ENTITY_CACHE_ENABLED,
			LastvideolistModelImpl.FINDER_CACHE_ENABLED,
			LastvideolistImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByGroup",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUP = new FinderPath(LastvideolistModelImpl.ENTITY_CACHE_ENABLED,
			LastvideolistModelImpl.FINDER_CACHE_ENABLED,
			LastvideolistImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByGroup", new String[] { Long.class.getName() },
			LastvideolistModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUP = new FinderPath(LastvideolistModelImpl.ENTITY_CACHE_ENABLED,
			LastvideolistModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public Lastvideolist findByGroup_First(long groupId,
		OrderByComparator<Lastvideolist> orderByComparator)
		throws NoSuchLastvideolistException {
		Lastvideolist lastvideolist = fetchByGroup_First(groupId,
				orderByComparator);
	 ...
	 */
	@Override
	public Lastvideolist fetchByGroup_First(long groupId,
		OrderByComparator<Lastvideolist> orderByComparator) {
		List<Lastvideolist> list = findByGroup(groupId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Lastvideolist findByGroup_Last(long groupId,
		OrderByComparator<Lastvideolist> orderByComparator)
		throws NoSuchLastvideolistException {
		Lastvideolist lastvideolist = fetchByGroup_Last(groupId,
				orderByComparator);
	 ...
	 */
	@Override
	public Lastvideolist fetchByGroup_Last(long groupId,
		OrderByComparator<Lastvideolist> orderByComparator) {
		...
		List<Lastvideolist> list = findByGroup(groupId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Lastvideolist[] findByGroup_PrevAndNext(int lastvideolistId,
		...
		try {
			...
			array[0] = getByGroup_PrevAndNext(session, lastvideolist, groupId,
					orderByComparator, true);

			array[1] = lastvideolist;

			array[2] = getByGroup_PrevAndNext(session, lastvideolist, groupId,
					orderByComparator, false);
	...
	protected Lastvideolist getByGroup_PrevAndNext(Session session,
		Lastvideolist lastvideolist, long groupId,
		OrderByComparator<Lastvideolist> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByGroup(long groupId) {
		for (Lastvideolist lastvideolist : findByGroup(groupId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(lastvideolist);
		}
	}
	...
	private static final String _FINDER_COLUMN_GROUP_GROUPID_2 = "lastvideolist.groupId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_COMPANY = new FinderPath(LastvideolistModelImpl.ENTITY_CACHE_ENABLED,
			LastvideolistModelImpl.FINDER_CACHE_ENABLED,
			LastvideolistImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByCompany",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANY =
		new FinderPath(LastvideolistModelImpl.ENTITY_CACHE_ENABLED,
			LastvideolistModelImpl.FINDER_CACHE_ENABLED,
			LastvideolistImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByCompany", new String[] { Long.class.getName() },
			LastvideolistModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANY = new FinderPath(LastvideolistModelImpl.ENTITY_CACHE_ENABLED,
			LastvideolistModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Lastvideolist> findByCompany(long companyId, int start, int end) {
	 ...
	 */
	@Override
	public List<Lastvideolist> findByCompany(long companyId, int start,
	 ...
	 */
	@Override
	public Lastvideolist findByCompany_First(long companyId,
		OrderByComparator<Lastvideolist> orderByComparator)
		throws NoSuchLastvideolistException {
		Lastvideolist lastvideolist = fetchByCompany_First(companyId,
				orderByComparator);
	 ...
	 */
	@Override
	public Lastvideolist fetchByCompany_First(long companyId,
		OrderByComparator<Lastvideolist> orderByComparator) {
		List<Lastvideolist> list = findByCompany(companyId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public Lastvideolist findByCompany_Last(long companyId,
		OrderByComparator<Lastvideolist> orderByComparator)
		throws NoSuchLastvideolistException {
		Lastvideolist lastvideolist = fetchByCompany_Last(companyId,
				orderByComparator);
	 ...
	 */
	@Override
	public Lastvideolist fetchByCompany_Last(long companyId,
		OrderByComparator<Lastvideolist> orderByComparator) {
		...
		List<Lastvideolist> list = findByCompany(companyId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Lastvideolist[] findByCompany_PrevAndNext(int lastvideolistId,
		...
		try {
			...
			array[0] = getByCompany_PrevAndNext(session, lastvideolist,
					companyId, orderByComparator, true);

			array[1] = lastvideolist;

			array[2] = getByCompany_PrevAndNext(session, lastvideolist,
	...
	protected Lastvideolist getByCompany_PrevAndNext(Session session,
		Lastvideolist lastvideolist, long companyId,
		OrderByComparator<Lastvideolist> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByCompany(long companyId) {
		for (Lastvideolist lastvideolist : findByCompany(companyId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(lastvideolist);
		}
	}
	...
	private static final String _FINDER_COLUMN_COMPANY_COMPANYID_2 = "lastvideolist.companyId = ?";
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPANDCOMPANY =
		new FinderPath(LastvideolistModelImpl.ENTITY_CACHE_ENABLED,
			...
			LastvideolistModelImpl.GROUPID_COLUMN_BITMASK |
			LastvideolistModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUPANDCOMPANY = new FinderPath(LastvideolistModelImpl.ENTITY_CACHE_ENABLED,
			LastvideolistModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Lastvideolist> findByGroupAndCompany(long groupId,
		long companyId) {
	 ...
	 */
	@Override
	public Lastvideolist findByGroupAndCompany_First(long groupId,
		long companyId, OrderByComparator<Lastvideolist> orderByComparator)
		throws NoSuchLastvideolistException {
		Lastvideolist lastvideolist = fetchByGroupAndCompany_First(groupId,
	 ...
	 */
	@Override
	public Lastvideolist fetchByGroupAndCompany_First(long groupId,
		long companyId, OrderByComparator<Lastvideolist> orderByComparator) {
		List<Lastvideolist> list = findByGroupAndCompany(groupId, companyId, 0,
				1, orderByComparator);
	 ...
	 */
	@Override
	public Lastvideolist findByGroupAndCompany_Last(long groupId,
		long companyId, OrderByComparator<Lastvideolist> orderByComparator)
		throws NoSuchLastvideolistException {
		Lastvideolist lastvideolist = fetchByGroupAndCompany_Last(groupId,
				companyId, orderByComparator);
	 ...
	 */
	@Override
	public Lastvideolist fetchByGroupAndCompany_Last(long groupId,
		long companyId, OrderByComparator<Lastvideolist> orderByComparator) {
		...
		List<Lastvideolist> list = findByGroupAndCompany(groupId, companyId,
	...
	public Lastvideolist[] findByGroupAndCompany_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroupAndCompany_PrevAndNext(session, lastvideolist,
					groupId, companyId, orderByComparator, true);

			array[1] = lastvideolist;

			array[2] = getByGroupAndCompany_PrevAndNext(session, lastvideolist,
	...
	protected Lastvideolist getByGroupAndCompany_PrevAndNext(Session session,
		Lastvideolist lastvideolist, long groupId, long companyId,
		OrderByComparator<Lastvideolist> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByGroupAndCompany(long groupId, long companyId) {
		for (Lastvideolist lastvideolist : findByGroupAndCompany(groupId,
	...
	private static final String _FINDER_COLUMN_GROUPANDCOMPANY_GROUPID_2 = "lastvideolist.groupId = ? AND ";
	private static final String _FINDER_COLUMN_GROUPANDCOMPANY_COMPANYID_2 = "lastvideolist.companyId = ?";
