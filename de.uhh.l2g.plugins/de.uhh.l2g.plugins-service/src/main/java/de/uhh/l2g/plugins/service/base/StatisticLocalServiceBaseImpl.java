...
public abstract class StatisticLocalServiceBaseImpl extends BaseLocalServiceImpl
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(statisticLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Statistic.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("statisticId");
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("de.uhh.l2g.plugins.model.Statistic",
