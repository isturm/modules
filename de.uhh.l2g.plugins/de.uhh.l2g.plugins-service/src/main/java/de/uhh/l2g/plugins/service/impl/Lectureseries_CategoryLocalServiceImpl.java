 ...
 *
 * @author Iavor Sturm
 * @see Lectureseries_CategoryLocalServiceBaseImpl
...
public class Lectureseries_CategoryLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Always use {@link de.uhh.l2g.plugins.service.Lectureseries_CategoryLocalServiceUtil} to access the lectureseries_ category local service.
	 */
}