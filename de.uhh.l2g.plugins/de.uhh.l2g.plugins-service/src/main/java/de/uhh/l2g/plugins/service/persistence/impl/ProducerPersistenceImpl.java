...
public class ProducerPersistenceImpl extends BasePersistenceImpl<Producer>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUP = new FinderPath(ProducerModelImpl.ENTITY_CACHE_ENABLED,
			ProducerModelImpl.FINDER_CACHE_ENABLED, ProducerImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUP = new FinderPath(ProducerModelImpl.ENTITY_CACHE_ENABLED,
			ProducerModelImpl.FINDER_CACHE_ENABLED, ProducerImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByGroup",
			new String[] { Long.class.getName() },
			ProducerModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUP = new FinderPath(ProducerModelImpl.ENTITY_CACHE_ENABLED,
			ProducerModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public Producer findByGroup_First(long groupId,
		OrderByComparator<Producer> orderByComparator)
		throws NoSuchProducerException {
	 ...
	 */
	@Override
	public Producer fetchByGroup_First(long groupId,
		OrderByComparator<Producer> orderByComparator) {
	 ...
	 */
	@Override
	public Producer findByGroup_Last(long groupId,
		OrderByComparator<Producer> orderByComparator)
		throws NoSuchProducerException {
	 ...
	 */
	@Override
	public Producer fetchByGroup_Last(long groupId,
		OrderByComparator<Producer> orderByComparator) {
		...
		List<Producer> list = findByGroup(groupId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Producer[] findByGroup_PrevAndNext(long producerId, long groupId,
		OrderByComparator<Producer> orderByComparator)
		throws NoSuchProducerException {
		Producer producer = findByPrimaryKey(producerId);
		...
		try {
			...
			array[0] = getByGroup_PrevAndNext(session, producer, groupId,
					orderByComparator, true);

			array[1] = producer;

			array[2] = getByGroup_PrevAndNext(session, producer, groupId,
					orderByComparator, false);
	...
	protected Producer getByGroup_PrevAndNext(Session session,
		Producer producer, long groupId,
		OrderByComparator<Producer> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByGroup(long groupId) {
		for (Producer producer : findByGroup(groupId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(producer);
		}
	}
	...
	private static final String _FINDER_COLUMN_GROUP_GROUPID_2 = "producer.groupId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_COMPANY = new FinderPath(ProducerModelImpl.ENTITY_CACHE_ENABLED,
			ProducerModelImpl.FINDER_CACHE_ENABLED, ProducerImpl.class,
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANY = new FinderPath(ProducerModelImpl.ENTITY_CACHE_ENABLED,
			ProducerModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public Producer findByCompany_First(long companyId,
		OrderByComparator<Producer> orderByComparator)
		throws NoSuchProducerException {
	 ...
	 */
	@Override
	public Producer fetchByCompany_First(long companyId,
		OrderByComparator<Producer> orderByComparator) {
	 ...
	 */
	@Override
	public Producer findByCompany_Last(long companyId,
		OrderByComparator<Producer> orderByComparator)
		throws NoSuchProducerException {
	 ...
	 */
	@Override
	public Producer fetchByCompany_Last(long companyId,
		OrderByComparator<Producer> orderByComparator) {
		...
		List<Producer> list = findByCompany(companyId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Producer[] findByCompany_PrevAndNext(long producerId,
		...
		try {
			...
			array[0] = getByCompany_PrevAndNext(session, producer, companyId,
					orderByComparator, true);

			array[1] = producer;

			array[2] = getByCompany_PrevAndNext(session, producer, companyId,
					orderByComparator, false);
	...
	protected Producer getByCompany_PrevAndNext(Session session,
		Producer producer, long companyId,
		OrderByComparator<Producer> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByCompany(long companyId) {
		for (Producer producer : findByCompany(companyId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(producer);
		}
	}
	...
	private static final String _FINDER_COLUMN_COMPANY_COMPANYID_2 = "producer.companyId = ?";
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPANDCOMPANY =
		new FinderPath(ProducerModelImpl.ENTITY_CACHE_ENABLED,
			...
			ProducerModelImpl.GROUPID_COLUMN_BITMASK |
			ProducerModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUPANDCOMPANY = new FinderPath(ProducerModelImpl.ENTITY_CACHE_ENABLED,
			ProducerModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public Producer findByGroupAndCompany_First(long groupId, long companyId,
		OrderByComparator<Producer> orderByComparator)
		throws NoSuchProducerException {
		Producer producer = fetchByGroupAndCompany_First(groupId, companyId,
				orderByComparator);
	 ...
	 */
	@Override
	public Producer fetchByGroupAndCompany_First(long groupId, long companyId,
		OrderByComparator<Producer> orderByComparator) {
		List<Producer> list = findByGroupAndCompany(groupId, companyId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public Producer findByGroupAndCompany_Last(long groupId, long companyId,
		OrderByComparator<Producer> orderByComparator)
		throws NoSuchProducerException {
		Producer producer = fetchByGroupAndCompany_Last(groupId, companyId,
				orderByComparator);
	 ...
	 */
	@Override
	public Producer fetchByGroupAndCompany_Last(long groupId, long companyId,
		OrderByComparator<Producer> orderByComparator) {
		...
		List<Producer> list = findByGroupAndCompany(groupId, companyId,
	 ...
	 */
	@Override
	public Producer[] findByGroupAndCompany_PrevAndNext(long producerId,
		...
		try {
			...
			array[0] = getByGroupAndCompany_PrevAndNext(session, producer,
					groupId, companyId, orderByComparator, true);

			array[1] = producer;

			array[2] = getByGroupAndCompany_PrevAndNext(session, producer,
	...
	protected Producer getByGroupAndCompany_PrevAndNext(Session session,
		Producer producer, long groupId, long companyId,
		OrderByComparator<Producer> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByGroupAndCompany(long groupId, long companyId) {
		for (Producer producer : findByGroupAndCompany(groupId, companyId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(producer);
		}
	}
	...
	private static final String _FINDER_COLUMN_GROUPANDCOMPANY_GROUPID_2 = "producer.groupId = ? AND ";
	private static final String _FINDER_COLUMN_GROUPANDCOMPANY_COMPANYID_2 = "producer.companyId = ?";
