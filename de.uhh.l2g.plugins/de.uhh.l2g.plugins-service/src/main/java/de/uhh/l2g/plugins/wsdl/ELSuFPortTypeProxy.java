...
public class ELSuFPortTypeProxy implements de.uhh.l2g.plugins.wsdl.ELSuFPortType {
  private String _endpoint = null;
  private de.uhh.l2g.plugins.wsdl.ELSuFPortType eLSuFPortType = null;
  ...
  private void _initELSuFPortTypeProxy() {
    try {
      eLSuFPortType = (new de.uhh.l2g.plugins.wsdl.ELSuFServiceLocator()).geteLSuFPort();
  ...
  public de.uhh.l2g.plugins.wsdl.ELSuFPortType getELSuFPortType() {
    if (eLSuFPortType == null)
      _initELSuFPortTypeProxy();
