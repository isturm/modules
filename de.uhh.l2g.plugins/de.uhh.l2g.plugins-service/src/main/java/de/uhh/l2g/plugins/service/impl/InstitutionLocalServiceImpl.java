 ...
 *
 * @author Iavor Sturm
 * @see InstitutionLocalServiceBaseImpl
...
public class InstitutionLocalServiceImpl extends InstitutionLocalServiceBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Always use {@link de.uhh.l2g.plugins.service.InstitutionLocalServiceUtil} to access the institution local service.
	 */
}