 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link TermModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link TermImpl}.
 * </p>
 *
 * @author Iavor Sturm
 * @see TermImpl
...
public class TermModelImpl extends BaseModelImpl<Term> implements TermModel {
	...
	private static final ClassLoader _classLoader = Term.class.getClassLoader();
