...
public class TagcloudPersistenceImpl extends BasePersistenceImpl<Tagcloud>
	...
	private static final String _FINDER_COLUMN_OBJECTCLASSTYPEANDOBJECTID_OBJECTID_2 =
		"tagcloud.objectId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUP = new FinderPath(TagcloudModelImpl.ENTITY_CACHE_ENABLED,
			TagcloudModelImpl.FINDER_CACHE_ENABLED, TagcloudImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUP = new FinderPath(TagcloudModelImpl.ENTITY_CACHE_ENABLED,
			TagcloudModelImpl.FINDER_CACHE_ENABLED, TagcloudImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByGroup",
			new String[] { Long.class.getName() },
			TagcloudModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUP = new FinderPath(TagcloudModelImpl.ENTITY_CACHE_ENABLED,
			TagcloudModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public Tagcloud findByGroup_First(long groupId,
		OrderByComparator<Tagcloud> orderByComparator)
		throws NoSuchTagcloudException {
	 ...
	 */
	@Override
	public Tagcloud fetchByGroup_First(long groupId,
		OrderByComparator<Tagcloud> orderByComparator) {
	 ...
	 */
	@Override
	public Tagcloud findByGroup_Last(long groupId,
		OrderByComparator<Tagcloud> orderByComparator)
		throws NoSuchTagcloudException {
	 ...
	 */
	@Override
	public Tagcloud fetchByGroup_Last(long groupId,
		OrderByComparator<Tagcloud> orderByComparator) {
		...
		List<Tagcloud> list = findByGroup(groupId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Tagcloud[] findByGroup_PrevAndNext(long tagcloudId, long groupId,
		OrderByComparator<Tagcloud> orderByComparator)
		throws NoSuchTagcloudException {
		Tagcloud tagcloud = findByPrimaryKey(tagcloudId);
		...
		try {
			...
			array[0] = getByGroup_PrevAndNext(session, tagcloud, groupId,
					orderByComparator, true);

			array[1] = tagcloud;

			array[2] = getByGroup_PrevAndNext(session, tagcloud, groupId,
					orderByComparator, false);
	...
	protected Tagcloud getByGroup_PrevAndNext(Session session,
		Tagcloud tagcloud, long groupId,
		OrderByComparator<Tagcloud> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByGroup(long groupId) {
		for (Tagcloud tagcloud : findByGroup(groupId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(tagcloud);
		}
	}
	...
	private static final String _FINDER_COLUMN_GROUP_GROUPID_2 = "tagcloud.groupId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_COMPANY = new FinderPath(TagcloudModelImpl.ENTITY_CACHE_ENABLED,
			TagcloudModelImpl.FINDER_CACHE_ENABLED, TagcloudImpl.class,
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANY = new FinderPath(TagcloudModelImpl.ENTITY_CACHE_ENABLED,
			TagcloudModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public Tagcloud findByCompany_First(long companyId,
		OrderByComparator<Tagcloud> orderByComparator)
		throws NoSuchTagcloudException {
	 ...
	 */
	@Override
	public Tagcloud fetchByCompany_First(long companyId,
		OrderByComparator<Tagcloud> orderByComparator) {
	 ...
	 */
	@Override
	public Tagcloud findByCompany_Last(long companyId,
		OrderByComparator<Tagcloud> orderByComparator)
		throws NoSuchTagcloudException {
	 ...
	 */
	@Override
	public Tagcloud fetchByCompany_Last(long companyId,
		OrderByComparator<Tagcloud> orderByComparator) {
		...
		List<Tagcloud> list = findByCompany(companyId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Tagcloud[] findByCompany_PrevAndNext(long tagcloudId,
		...
		try {
			...
			array[0] = getByCompany_PrevAndNext(session, tagcloud, companyId,
					orderByComparator, true);

			array[1] = tagcloud;

			array[2] = getByCompany_PrevAndNext(session, tagcloud, companyId,
					orderByComparator, false);
	...
	protected Tagcloud getByCompany_PrevAndNext(Session session,
		Tagcloud tagcloud, long companyId,
		OrderByComparator<Tagcloud> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByCompany(long companyId) {
		for (Tagcloud tagcloud : findByCompany(companyId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(tagcloud);
		}
	}
	...
	private static final String _FINDER_COLUMN_COMPANY_COMPANYID_2 = "tagcloud.companyId = ?";
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPANDCOMPANY =
		new FinderPath(TagcloudModelImpl.ENTITY_CACHE_ENABLED,
			...
			TagcloudModelImpl.GROUPID_COLUMN_BITMASK |
			TagcloudModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUPANDCOMPANY = new FinderPath(TagcloudModelImpl.ENTITY_CACHE_ENABLED,
			TagcloudModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
	 ...
	 */
	@Override
	public Tagcloud findByGroupAndCompany_First(long groupId, long companyId,
		OrderByComparator<Tagcloud> orderByComparator)
		throws NoSuchTagcloudException {
		Tagcloud tagcloud = fetchByGroupAndCompany_First(groupId, companyId,
				orderByComparator);
	 ...
	 */
	@Override
	public Tagcloud fetchByGroupAndCompany_First(long groupId, long companyId,
		OrderByComparator<Tagcloud> orderByComparator) {
		List<Tagcloud> list = findByGroupAndCompany(groupId, companyId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public Tagcloud findByGroupAndCompany_Last(long groupId, long companyId,
		OrderByComparator<Tagcloud> orderByComparator)
		throws NoSuchTagcloudException {
		Tagcloud tagcloud = fetchByGroupAndCompany_Last(groupId, companyId,
				orderByComparator);
	 ...
	 */
	@Override
	public Tagcloud fetchByGroupAndCompany_Last(long groupId, long companyId,
		OrderByComparator<Tagcloud> orderByComparator) {
		...
		List<Tagcloud> list = findByGroupAndCompany(groupId, companyId,
	 ...
	 */
	@Override
	public Tagcloud[] findByGroupAndCompany_PrevAndNext(long tagcloudId,
		...
		try {
			...
			array[0] = getByGroupAndCompany_PrevAndNext(session, tagcloud,
					groupId, companyId, orderByComparator, true);

			array[1] = tagcloud;

			array[2] = getByGroupAndCompany_PrevAndNext(session, tagcloud,
	...
	protected Tagcloud getByGroupAndCompany_PrevAndNext(Session session,
		Tagcloud tagcloud, long groupId, long companyId,
		OrderByComparator<Tagcloud> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByGroupAndCompany(long groupId, long companyId) {
		for (Tagcloud tagcloud : findByGroupAndCompany(groupId, companyId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(tagcloud);
		}
	}
	...
	private static final String _FINDER_COLUMN_GROUPANDCOMPANY_GROUPID_2 = "tagcloud.groupId = ? AND ";
	private static final String _FINDER_COLUMN_GROUPANDCOMPANY_COMPANYID_2 = "tagcloud.companyId = ?";
