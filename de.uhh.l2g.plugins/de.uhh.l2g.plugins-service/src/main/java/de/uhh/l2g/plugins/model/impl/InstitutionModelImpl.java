 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link InstitutionModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link InstitutionImpl}.
 * </p>
 *
 * @author Iavor Sturm
 * @see InstitutionImpl
...
public class InstitutionModelImpl extends BaseModelImpl<Institution>
	...
	public static final String TABLE_SQL_CREATE = "create table LG_Institution (institutionId LONG not null primary key,parentId LONG,name VARCHAR(75) null,typ VARCHAR(75) null,www VARCHAR(75) null,level INTEGER,sort INTEGER,groupId LONG,companyId LONG)";
	...
	private static final ClassLoader _classLoader = Institution.class.getClassLoader();
