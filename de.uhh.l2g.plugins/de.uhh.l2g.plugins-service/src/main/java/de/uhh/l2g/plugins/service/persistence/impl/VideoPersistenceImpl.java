...
public class VideoPersistenceImpl
	...
	protected Video getByGroup_PrevAndNext(
	 ...
	 */
	@Override
	public List<Video> findByCompany(
	...
	public Video[] findByCompany_PrevAndNext(
		...
		try {
			...
			array[0] = getByCompany_PrevAndNext(
				session, video, companyId, orderByComparator, true);

			array[1] = video;

			array[2] = getByCompany_PrevAndNext(
				session, video, companyId, orderByComparator, false);
	...
	protected Video getByCompany_PrevAndNext(
		Session session, Video video, long companyId,
		OrderByComparator<Video> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public List<Video> findByGroupAndCompany(
	...
	public Video findByGroupAndCompany_First(
		...
		Video video = fetchByGroupAndCompany_First(
	...
	public Video fetchByGroupAndCompany_First(
		...
		List<Video> list = findByGroupAndCompany(
	...
	public Video findByGroupAndCompany_Last(
		...
		Video video = fetchByGroupAndCompany_Last(
			groupId, companyId, orderByComparator);
	...
	public Video[] findByGroupAndCompany_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroupAndCompany_PrevAndNext(
				session, video, groupId, companyId, orderByComparator, true);

			array[1] = video;

			array[2] = getByGroupAndCompany_PrevAndNext(
				session, video, groupId, companyId, orderByComparator, false);
	...
	protected Video getByGroupAndCompany_PrevAndNext(
		Session session, Video video, long groupId, long companyId,
		OrderByComparator<Video> orderByComparator, boolean previous) {
