...
public class CreatorPersistenceImpl extends BasePersistenceImpl<Creator>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUP = new FinderPath(CreatorModelImpl.ENTITY_CACHE_ENABLED,
			CreatorModelImpl.FINDER_CACHE_ENABLED, CreatorImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUP = new FinderPath(CreatorModelImpl.ENTITY_CACHE_ENABLED,
			CreatorModelImpl.FINDER_CACHE_ENABLED, CreatorImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByGroup",
			new String[] { Long.class.getName() },
			CreatorModelImpl.GROUPID_COLUMN_BITMASK |
			CreatorModelImpl.LASTNAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUP = new FinderPath(CreatorModelImpl.ENTITY_CACHE_ENABLED,
			CreatorModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public Creator fetchByGroup_Last(long groupId,
		...
		List<Creator> list = findByGroup(groupId, count - 1, count,
				orderByComparator);
	...
	public Creator[] findByGroup_PrevAndNext(long creatorId, long groupId,
		...
		try {
			...
			array[0] = getByGroup_PrevAndNext(session, creator, groupId,
					orderByComparator, true);

			array[1] = creator;

			array[2] = getByGroup_PrevAndNext(session, creator, groupId,
					orderByComparator, false);
	...
	protected Creator getByGroup_PrevAndNext(Session session, Creator creator,
	...
	public void removeByGroup(long groupId) {
		for (Creator creator : findByGroup(groupId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(creator);
		}
	}
	...
	private static final String _FINDER_COLUMN_GROUP_GROUPID_2 = "creator.groupId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_COMPANY = new FinderPath(CreatorModelImpl.ENTITY_CACHE_ENABLED,
			CreatorModelImpl.FINDER_CACHE_ENABLED, CreatorImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANY =
		new FinderPath(CreatorModelImpl.ENTITY_CACHE_ENABLED,
			...
			CreatorModelImpl.LASTNAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANY = new FinderPath(CreatorModelImpl.ENTITY_CACHE_ENABLED,
			CreatorModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public Creator fetchByCompany_Last(long companyId,
		...
		List<Creator> list = findByCompany(companyId, count - 1, count,
				orderByComparator);
	...
	public Creator[] findByCompany_PrevAndNext(long creatorId, long companyId,
		...
		try {
			...
			array[0] = getByCompany_PrevAndNext(session, creator, companyId,
					orderByComparator, true);

			array[1] = creator;

			array[2] = getByCompany_PrevAndNext(session, creator, companyId,
					orderByComparator, false);
	...
	protected Creator getByCompany_PrevAndNext(Session session,
		Creator creator, long companyId,
		OrderByComparator<Creator> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByCompany(long companyId) {
		for (Creator creator : findByCompany(companyId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(creator);
		}
	}
	...
	private static final String _FINDER_COLUMN_COMPANY_COMPANYID_2 = "creator.companyId = ?";
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPANDCOMPANY =
		new FinderPath(CreatorModelImpl.ENTITY_CACHE_ENABLED,
			...
			CreatorModelImpl.COMPANYID_COLUMN_BITMASK |
			CreatorModelImpl.LASTNAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUPANDCOMPANY = new FinderPath(CreatorModelImpl.ENTITY_CACHE_ENABLED,
			CreatorModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public Creator findByGroupAndCompany_First(long groupId, long companyId,
		OrderByComparator<Creator> orderByComparator)
		throws NoSuchCreatorException {
		Creator creator = fetchByGroupAndCompany_First(groupId, companyId,
				orderByComparator);
	...
	public Creator fetchByGroupAndCompany_First(long groupId, long companyId,
		OrderByComparator<Creator> orderByComparator) {
		List<Creator> list = findByGroupAndCompany(groupId, companyId, 0, 1,
				orderByComparator);
	...
	public Creator findByGroupAndCompany_Last(long groupId, long companyId,
		OrderByComparator<Creator> orderByComparator)
		throws NoSuchCreatorException {
		Creator creator = fetchByGroupAndCompany_Last(groupId, companyId,
				orderByComparator);
	...
	public Creator fetchByGroupAndCompany_Last(long groupId, long companyId,
		...
		List<Creator> list = findByGroupAndCompany(groupId, companyId,
	...
	public Creator[] findByGroupAndCompany_PrevAndNext(long creatorId,
		...
		try {
			...
			array[0] = getByGroupAndCompany_PrevAndNext(session, creator,
					groupId, companyId, orderByComparator, true);

			array[1] = creator;

			array[2] = getByGroupAndCompany_PrevAndNext(session, creator,
	...
	protected Creator getByGroupAndCompany_PrevAndNext(Session session,
		Creator creator, long groupId, long companyId,
		OrderByComparator<Creator> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByGroupAndCompany(long groupId, long companyId) {
		for (Creator creator : findByGroupAndCompany(groupId, companyId,
	...
	private static final String _FINDER_COLUMN_GROUPANDCOMPANY_GROUPID_2 = "creator.groupId = ? AND ";
	private static final String _FINDER_COLUMN_GROUPANDCOMPANY_COMPANYID_2 = "creator.companyId = ?";
