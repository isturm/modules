 ...
 *
 * @author Iavor Sturm
 * @see ScheduledThreadLocalServiceBaseImpl
...
public class ScheduledThreadLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Always use {@link de.uhh.l2g.plugins.service.ScheduledThreadLocalServiceUtil} to access the scheduled thread local service.
	 */
}