...
package de.uhh.l2g.plugins.wsdl;

public class ELSuFServiceLocator extends org.apache.axis.client.Service implements de.uhh.l2g.plugins.wsdl.ELSuFService {
    ...
    public de.uhh.l2g.plugins.wsdl.ELSuFPortType geteLSuFPort() throws javax.xml.rpc.ServiceException {
    ...
    public de.uhh.l2g.plugins.wsdl.ELSuFPortType geteLSuFPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	de.uhh.l2g.plugins.wsdl.ELSuFBindingStub _stub = new de.uhh.l2g.plugins.wsdl.ELSuFBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.uhh.l2g.plugins.wsdl.ELSuFPortType.class.isAssignableFrom(serviceEndpointInterface)) {
            	de.uhh.l2g.plugins.wsdl.ELSuFBindingStub _stub = new de.uhh.l2g.plugins.wsdl.ELSuFBindingStub(new java.net.URL(eLSuFPort_address), this);
                _stub.setPortName(geteLSuFPortWSDDServiceName());
                return _stub;
            }
        }
