 ...
 *
 * @author Iavor Sturm
 * @see CreatorLocalServiceBaseImpl
...
public class CreatorLocalServiceImpl extends CreatorLocalServiceBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Always use {@link de.uhh.l2g.plugins.service.CreatorLocalServiceUtil} to access the creator local service.
	 */
}