...
public class VideohitlistPersistenceImpl extends BasePersistenceImpl<Videohitlist>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUP = new FinderPath(VideohitlistModelImpl.ENTITY_CACHE_ENABLED,
			VideohitlistModelImpl.FINDER_CACHE_ENABLED, VideohitlistImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUP = new FinderPath(VideohitlistModelImpl.ENTITY_CACHE_ENABLED,
			VideohitlistModelImpl.FINDER_CACHE_ENABLED, VideohitlistImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByGroup",
			new String[] { Long.class.getName() },
			VideohitlistModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUP = new FinderPath(VideohitlistModelImpl.ENTITY_CACHE_ENABLED,
			VideohitlistModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public Videohitlist findByGroup_First(long groupId,
		OrderByComparator<Videohitlist> orderByComparator)
		throws NoSuchVideohitlistException {
		Videohitlist videohitlist = fetchByGroup_First(groupId,
				orderByComparator);
	 ...
	 */
	@Override
	public Videohitlist fetchByGroup_First(long groupId,
		OrderByComparator<Videohitlist> orderByComparator) {
	 ...
	 */
	@Override
	public Videohitlist findByGroup_Last(long groupId,
		OrderByComparator<Videohitlist> orderByComparator)
		throws NoSuchVideohitlistException {
		Videohitlist videohitlist = fetchByGroup_Last(groupId, orderByComparator);
	 ...
	 */
	@Override
	public Videohitlist fetchByGroup_Last(long groupId,
		OrderByComparator<Videohitlist> orderByComparator) {
		...
		List<Videohitlist> list = findByGroup(groupId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Videohitlist[] findByGroup_PrevAndNext(long videohitlistId,
		...
		try {
			...
			array[0] = getByGroup_PrevAndNext(session, videohitlist, groupId,
					orderByComparator, true);

			array[1] = videohitlist;

			array[2] = getByGroup_PrevAndNext(session, videohitlist, groupId,
					orderByComparator, false);
	...
	protected Videohitlist getByGroup_PrevAndNext(Session session,
		Videohitlist videohitlist, long groupId,
		OrderByComparator<Videohitlist> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByGroup(long groupId) {
		for (Videohitlist videohitlist : findByGroup(groupId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(videohitlist);
		}
	}
	...
	private static final String _FINDER_COLUMN_GROUP_GROUPID_2 = "videohitlist.groupId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_COMPANY = new FinderPath(VideohitlistModelImpl.ENTITY_CACHE_ENABLED,
			VideohitlistModelImpl.FINDER_CACHE_ENABLED, VideohitlistImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANY =
		new FinderPath(VideohitlistModelImpl.ENTITY_CACHE_ENABLED,
			VideohitlistModelImpl.FINDER_CACHE_ENABLED, VideohitlistImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByCompany",
			new String[] { Long.class.getName() },
			VideohitlistModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANY = new FinderPath(VideohitlistModelImpl.ENTITY_CACHE_ENABLED,
			VideohitlistModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Videohitlist> findByCompany(long companyId, int start, int end) {
	 ...
	 */
	@Override
	public Videohitlist findByCompany_First(long companyId,
		OrderByComparator<Videohitlist> orderByComparator)
		throws NoSuchVideohitlistException {
		Videohitlist videohitlist = fetchByCompany_First(companyId,
				orderByComparator);
	 ...
	 */
	@Override
	public Videohitlist fetchByCompany_First(long companyId,
		OrderByComparator<Videohitlist> orderByComparator) {
		List<Videohitlist> list = findByCompany(companyId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public Videohitlist findByCompany_Last(long companyId,
		OrderByComparator<Videohitlist> orderByComparator)
		throws NoSuchVideohitlistException {
		Videohitlist videohitlist = fetchByCompany_Last(companyId,
				orderByComparator);
	 ...
	 */
	@Override
	public Videohitlist fetchByCompany_Last(long companyId,
		OrderByComparator<Videohitlist> orderByComparator) {
		...
		List<Videohitlist> list = findByCompany(companyId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Videohitlist[] findByCompany_PrevAndNext(long videohitlistId,
		...
		try {
			...
			array[0] = getByCompany_PrevAndNext(session, videohitlist,
					companyId, orderByComparator, true);

			array[1] = videohitlist;

			array[2] = getByCompany_PrevAndNext(session, videohitlist,
	...
	protected Videohitlist getByCompany_PrevAndNext(Session session,
		Videohitlist videohitlist, long companyId,
		OrderByComparator<Videohitlist> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByCompany(long companyId) {
		for (Videohitlist videohitlist : findByCompany(companyId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(videohitlist);
		}
	}
	...
	private static final String _FINDER_COLUMN_COMPANY_COMPANYID_2 = "videohitlist.companyId = ?";
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPANDCOMPANY =
		new FinderPath(VideohitlistModelImpl.ENTITY_CACHE_ENABLED,
			...
			VideohitlistModelImpl.GROUPID_COLUMN_BITMASK |
			VideohitlistModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUPANDCOMPANY = new FinderPath(VideohitlistModelImpl.ENTITY_CACHE_ENABLED,
			VideohitlistModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Videohitlist> findByGroupAndCompany(long groupId, long companyId) {
	 ...
	 */
	@Override
	public List<Videohitlist> findByGroupAndCompany(long groupId,
	 ...
	 */
	@Override
	public Videohitlist findByGroupAndCompany_First(long groupId,
		long companyId, OrderByComparator<Videohitlist> orderByComparator)
		throws NoSuchVideohitlistException {
		Videohitlist videohitlist = fetchByGroupAndCompany_First(groupId,
	 ...
	 */
	@Override
	public Videohitlist fetchByGroupAndCompany_First(long groupId,
		long companyId, OrderByComparator<Videohitlist> orderByComparator) {
		List<Videohitlist> list = findByGroupAndCompany(groupId, companyId, 0,
				1, orderByComparator);
	 ...
	 */
	@Override
	public Videohitlist findByGroupAndCompany_Last(long groupId,
		long companyId, OrderByComparator<Videohitlist> orderByComparator)
		throws NoSuchVideohitlistException {
		Videohitlist videohitlist = fetchByGroupAndCompany_Last(groupId,
				companyId, orderByComparator);
	 ...
	 */
	@Override
	public Videohitlist fetchByGroupAndCompany_Last(long groupId,
		long companyId, OrderByComparator<Videohitlist> orderByComparator) {
		...
		List<Videohitlist> list = findByGroupAndCompany(groupId, companyId,
	...
	public Videohitlist[] findByGroupAndCompany_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroupAndCompany_PrevAndNext(session, videohitlist,
					groupId, companyId, orderByComparator, true);

			array[1] = videohitlist;

			array[2] = getByGroupAndCompany_PrevAndNext(session, videohitlist,
	...
	protected Videohitlist getByGroupAndCompany_PrevAndNext(Session session,
		Videohitlist videohitlist, long groupId, long companyId,
		OrderByComparator<Videohitlist> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByGroupAndCompany(long groupId, long companyId) {
		for (Videohitlist videohitlist : findByGroupAndCompany(groupId,
	...
	private static final String _FINDER_COLUMN_GROUPANDCOMPANY_GROUPID_2 = "videohitlist.groupId = ? AND ";
	private static final String _FINDER_COLUMN_GROUPANDCOMPANY_COMPANYID_2 = "videohitlist.companyId = ?";
